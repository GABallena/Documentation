...
\begin{tcolorbox}[title=Rationale]
	Welcome to my daily entries, consider this as a way for me to show that I am not simply lying around in bed all day when I am not on-site. Because rarely, is there anything to do when I am on-site besides staring at the wall of annex 2 because all the paperwork is pending. Moreover, transportation from my place to the site takes a significant fraction of the day (4-6 hours) which I consider unproductive, and would rather use that time to either be refining my scripts, documenting workflows, or simply calling the office to actually check if the relevant people are present in their office than blindly going in there and finding out that they are NOT in office - which costs a lot of time and effort, and more bureaucratic paperwork because of reimbursement processes.
	
	Let me kindly inform you that being on-site does not necessarily equal productivity. Being present is not useful if you are not doing anything there. Yes, some things need on-site movement such as moving hard-copies of documents around - and perhaps consistent pestering of administrative employees. But do know that a technological novelty called the telephone existed since the 1900s and we can pester people for updates a couple hundred kilometers away.
	
	\textbf{Note:} The updates do not necessarily end at 12 Midnight, as sometimes I work past that. Instead, a "day" starts counting when I wake up from sleep and ends when I go back to sleep.
\end{tcolorbox}
...
\begin{multicols}{2}
	...
	\begin{itemize}
		\item [\done] Proposed (TBA) annotation of Phage genes -- updated MGE-ARG section to include the initial plan
	...
	\textbf{Completed Tasks}
	\begin{itemize}
		\item [\done] Updated the bioconda fetching script to retry the in case of server timeout
		
	\end{itemize}
	
	\textbf{Scripts Worked On}
	\begin{itemize}
		\item bioconda\_search.py
	\end{itemize}
