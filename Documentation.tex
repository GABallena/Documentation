...
\textbf{Creation of assembly scripts}
...
\textbf{ Testing of Assembly Scripts}
...
\textbf{Further investigation of scripts}
...
\\ \textbf{Extra note} A \texttt{Python} script is included in the pipeline that is determine visualize and check how the coverage changes over contig regions. In general, they could be interpreted as the following:
	...
	\end{enumerate}
		...
		\textbf{Read mapping more details}
...
\subsubsection{Taxonomic profiling of reads and contigs}
...
\subsubsection{Detect structural variants (SVs) in contigs}
...
\subsection{Mobile Genetic Elements (TBA)}
...
\subsubsection{Sketching contigs followed by calculating \texttt{Bray-Curtis} diversity}
...
\subsubsection{Determination of putative plasmids}
...
\subsubsection{Phage influence signatures}
...
\subsubsection{Phage Signature Extraction and Phylogenetic Analysis}
