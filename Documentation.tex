...
\begin{tcolorbox}
	Now updated (December 01, 2024) to renamingSIMS.sh - a four liner. Found a way to make the script more efficient. Also, added two more functions to the script
	\begin{itemize}
		\item Split the interleaved reads using \texttt{seqtk}
		\item Re-zip them to save space
	\end{itemize} 
\end{tcolorbox}
