...
\section*{Stage: Further refinement}   
\section*{Purpose: Bootstrapping the taxo\_metagenomic pipeline itself}
...
\textbf{Directory setup of temporary files}
...
\textbf{Run \texttt{kraken\_pipeline.bash}}
